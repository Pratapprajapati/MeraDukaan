    ...
    return (
        <div className="p-4 bg-gray-900 min-h-screen text-white rounded-lg">
            ...
            <div className='flex items-center space-x-2 mb-6'>
                <div className="flex items-center bg-gray-800 rounded-lg ps-2 pe-1 py-1 flex-grow">
                    <input
                        type="text"
                ...
                <select
                    className="flex items-center text-sm rounded-lg font-medium cursor-pointer bg-gray-800 text-white py-2 px-3 border border-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors"
